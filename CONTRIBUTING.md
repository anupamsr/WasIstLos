...
You can contribute by opening issues, resolving any issue especially [good first issues](https://github.com/anupamsr/WasIstLos/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
improving documentation, adding [translations](https://github.com/anupamsr/WasIstLos/wiki#translations) in your language etc.

### Submitting changes

Please send a [GitHub Pull Request to WasIstLos](https://github.com/anupamsr/WasIstLos/pull/new/master) with a clear list of what you've done.
